SubProceso MatrizDefinida(matriz)
	matriz[0,0]<-'01';
	matriz[0,1]<-'02';
	matriz[0,2]<-'03';
	matriz[0,3]<-'04';
	...
	matriz[3,4]<-'20';
FinSubProceso
SubProceso MatrizInvertida(matriz)
	Definir ColumnaInicial,pasos,limite,filas,columnas Como Numerica;
	Filas<-4;
	Columnas<-4;
	limite<-4;
	Pasos<-1;
